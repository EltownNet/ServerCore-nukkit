...
public class UnbanlogCommand extends PluginCommand<ServerCore> {

    public UnbanlogCommand(final ServerCore owner) {
        super("unbanlog", owner);
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            final CustomForm formWindowCustom = new CustomForm.Builder("§7» §8Unbanlog")
                        ...
                        this.getPlugin().getTinyRabbit().sendAndReceive((delivery -> {
                            switch (GuardianCalls.valueOf(delivery.getKey().toUpperCase())) {
                                ...
                                case CALLBACK_UNBAN_BEHAVIOR_ENTRIES_RECEIVED:
                                    ...
                                    final SimpleForm form = new SimpleForm.Builder("§7» §8Unbanlog", content.toString()).build();
                                    form.send(e);
                                    break;
                            }
