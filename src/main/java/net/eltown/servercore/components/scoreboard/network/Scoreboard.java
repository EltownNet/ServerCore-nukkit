...
import lombok.Data;
import net.eltown.servercore.components.scoreboard.map.Long2ObjectArrayMap;
import net.eltown.servercore.components.scoreboard.network.packet.RemoveObjectivePacket;
import net.eltown.servercore.components.scoreboard.network.packet.SetObjectivePacket;
import net.eltown.servercore.components.scoreboard.network.packet.SetScorePacket;
